...
@InputType()
class CandidateDocumentCreateNestedManyWithoutCandidatesInput {
...
export { CandidateDocumentCreateNestedManyWithoutCandidatesInput as CandidateDocumentCreateNestedManyWithoutCandidatesInput };
