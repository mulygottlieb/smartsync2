...
@InputType()
class CandidateFeedbackCreateNestedManyWithoutCandidatesInput {
...
export { CandidateFeedbackCreateNestedManyWithoutCandidatesInput as CandidateFeedbackCreateNestedManyWithoutCandidatesInput };
