...
@InputType()
class CandidateInterviewCreateNestedManyWithoutCandidatesInput {
...
export { CandidateInterviewCreateNestedManyWithoutCandidatesInput as CandidateInterviewCreateNestedManyWithoutCandidatesInput };
