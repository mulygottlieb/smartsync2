...
describe("CandidateEducation", () => {
  ...
  test("POST /candidateEducations", async () => {
    await request(app.getHttpServer())
      .post("/candidateEducations")
      .send(CREATE_INPUT)
  ...
  test("GET /candidateEducations", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /candidateEducations/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/candidateEducations"}/${nonExistingId}`)
  ...
  test("GET /candidateEducations/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/candidateEducations"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /candidateEducations existing resource", async () => {
