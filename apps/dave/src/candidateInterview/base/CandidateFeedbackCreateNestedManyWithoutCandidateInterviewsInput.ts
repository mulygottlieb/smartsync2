...
@InputType()
class CandidateFeedbackCreateNestedManyWithoutCandidateInterviewsInput {
...
export { CandidateFeedbackCreateNestedManyWithoutCandidateInterviewsInput as CandidateFeedbackCreateNestedManyWithoutCandidateInterviewsInput };
