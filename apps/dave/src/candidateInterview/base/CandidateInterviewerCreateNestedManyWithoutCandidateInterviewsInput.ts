...
@InputType()
class CandidateInterviewerCreateNestedManyWithoutCandidateInterviewsInput {
...
export { CandidateInterviewerCreateNestedManyWithoutCandidateInterviewsInput as CandidateInterviewerCreateNestedManyWithoutCandidateInterviewsInput };
