...
@InputType()
class AvailabilitySlotCreateNestedManyWithoutEmployeesInput {
...
export { AvailabilitySlotCreateNestedManyWithoutEmployeesInput as AvailabilitySlotCreateNestedManyWithoutEmployeesInput };
