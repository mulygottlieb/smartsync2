...
@InputType()
class AvailabilitySlotUpdateManyWithoutEmployeesInput {
...
export { AvailabilitySlotUpdateManyWithoutEmployeesInput as AvailabilitySlotUpdateManyWithoutEmployeesInput };
