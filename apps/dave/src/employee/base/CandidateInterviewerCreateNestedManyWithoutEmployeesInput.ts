...
@InputType()
class CandidateInterviewerCreateNestedManyWithoutEmployeesInput {
...
export { CandidateInterviewerCreateNestedManyWithoutEmployeesInput as CandidateInterviewerCreateNestedManyWithoutEmployeesInput };
