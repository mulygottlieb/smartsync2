...
@InputType()
class CandidateInterviewerUpdateManyWithoutEmployeesInput {
...
export { CandidateInterviewerUpdateManyWithoutEmployeesInput as CandidateInterviewerUpdateManyWithoutEmployeesInput };
