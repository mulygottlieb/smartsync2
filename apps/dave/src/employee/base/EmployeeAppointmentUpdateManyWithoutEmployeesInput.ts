...
@InputType()
class EmployeeAppointmentUpdateManyWithoutEmployeesInput {
...
export { EmployeeAppointmentUpdateManyWithoutEmployeesInput as EmployeeAppointmentUpdateManyWithoutEmployeesInput };
