...
@InputType()
class EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutEmployeesInput {
...
export { EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutEmployeesInput as EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutEmployeesInput };
