...
@InputType()
class EmployeeUpworkJobSearchCriterionUpdateManyWithoutEmployeesInput {
...
export { EmployeeUpworkJobSearchCriterionUpdateManyWithoutEmployeesInput as EmployeeUpworkJobSearchCriterionUpdateManyWithoutEmployeesInput };
