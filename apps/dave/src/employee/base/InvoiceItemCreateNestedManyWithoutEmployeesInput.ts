...
@InputType()
class InvoiceItemCreateNestedManyWithoutEmployeesInput {
...
export { InvoiceItemCreateNestedManyWithoutEmployeesInput as InvoiceItemCreateNestedManyWithoutEmployeesInput };
