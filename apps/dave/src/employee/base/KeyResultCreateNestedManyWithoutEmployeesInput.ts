...
@InputType()
class KeyResultCreateNestedManyWithoutEmployeesInput {
...
export { KeyResultCreateNestedManyWithoutEmployeesInput as KeyResultCreateNestedManyWithoutEmployeesInput };
