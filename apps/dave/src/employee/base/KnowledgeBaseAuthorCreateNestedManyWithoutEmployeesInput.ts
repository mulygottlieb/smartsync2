...
@InputType()
class KnowledgeBaseAuthorCreateNestedManyWithoutEmployeesInput {
...
export { KnowledgeBaseAuthorCreateNestedManyWithoutEmployeesInput as KnowledgeBaseAuthorCreateNestedManyWithoutEmployeesInput };
