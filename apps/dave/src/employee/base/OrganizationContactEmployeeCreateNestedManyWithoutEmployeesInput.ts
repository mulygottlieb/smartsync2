...
@InputType()
class OrganizationContactEmployeeCreateNestedManyWithoutEmployeesInput {
...
export { OrganizationContactEmployeeCreateNestedManyWithoutEmployeesInput as OrganizationContactEmployeeCreateNestedManyWithoutEmployeesInput };
