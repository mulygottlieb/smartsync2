...
@InputType()
class OrganizationContactEmployeeUpdateManyWithoutEmployeesInput {
...
export { OrganizationContactEmployeeUpdateManyWithoutEmployeesInput as OrganizationContactEmployeeUpdateManyWithoutEmployeesInput };
