...
@InputType()
class OrganizationDepartmentEmployeeCreateNestedManyWithoutEmployeesInput {
...
export { OrganizationDepartmentEmployeeCreateNestedManyWithoutEmployeesInput as OrganizationDepartmentEmployeeCreateNestedManyWithoutEmployeesInput };
