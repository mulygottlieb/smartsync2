...
@InputType()
class OrganizationProjectEmployeeCreateNestedManyWithoutEmployeesInput {
...
export { OrganizationProjectEmployeeCreateNestedManyWithoutEmployeesInput as OrganizationProjectEmployeeCreateNestedManyWithoutEmployeesInput };
