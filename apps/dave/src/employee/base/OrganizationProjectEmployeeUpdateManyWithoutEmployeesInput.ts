...
@InputType()
class OrganizationProjectEmployeeUpdateManyWithoutEmployeesInput {
...
export { OrganizationProjectEmployeeUpdateManyWithoutEmployeesInput as OrganizationProjectEmployeeUpdateManyWithoutEmployeesInput };
