...
@InputType()
class ProposalCreateNestedManyWithoutEmployeesInput {
...
export { ProposalCreateNestedManyWithoutEmployeesInput as ProposalCreateNestedManyWithoutEmployeesInput };
