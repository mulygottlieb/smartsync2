...
@InputType()
class TagEmployeeCreateNestedManyWithoutEmployeesInput {
...
export { TagEmployeeCreateNestedManyWithoutEmployeesInput as TagEmployeeCreateNestedManyWithoutEmployeesInput };
