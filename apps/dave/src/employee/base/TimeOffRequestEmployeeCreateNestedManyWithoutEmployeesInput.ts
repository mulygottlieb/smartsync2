...
@InputType()
class TimeOffRequestEmployeeCreateNestedManyWithoutEmployeesInput {
...
export { TimeOffRequestEmployeeCreateNestedManyWithoutEmployeesInput as TimeOffRequestEmployeeCreateNestedManyWithoutEmployeesInput };
