...
@InputType()
class TimeSlotCreateNestedManyWithoutEmployeesInput {
...
export { TimeSlotCreateNestedManyWithoutEmployeesInput as TimeSlotCreateNestedManyWithoutEmployeesInput };
