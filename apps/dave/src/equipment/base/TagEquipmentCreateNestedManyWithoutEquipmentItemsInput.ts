...
@InputType()
class TagEquipmentCreateNestedManyWithoutEquipmentItemsInput {
...
export { TagEquipmentCreateNestedManyWithoutEquipmentItemsInput as TagEquipmentCreateNestedManyWithoutEquipmentItemsInput };
