...
@InputType()
class EquipmentSharesEmployeeCreateNestedManyWithoutEquipmentSharingsInput {
...
export { EquipmentSharesEmployeeCreateNestedManyWithoutEquipmentSharingsInput as EquipmentSharesEmployeeCreateNestedManyWithoutEquipmentSharingsInput };
