...
@InputType()
class EquipmentSharesTeamCreateNestedManyWithoutEquipmentSharingsInput {
...
export { EquipmentSharesTeamCreateNestedManyWithoutEquipmentSharingsInput as EquipmentSharesTeamCreateNestedManyWithoutEquipmentSharingsInput };
