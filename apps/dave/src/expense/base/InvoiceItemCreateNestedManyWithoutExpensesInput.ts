...
@InputType()
class InvoiceItemCreateNestedManyWithoutExpensesInput {
...
export { InvoiceItemCreateNestedManyWithoutExpensesInput as InvoiceItemCreateNestedManyWithoutExpensesInput };
