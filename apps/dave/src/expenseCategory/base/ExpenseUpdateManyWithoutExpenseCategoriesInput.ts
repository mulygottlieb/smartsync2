...
@InputType()
class ExpenseUpdateManyWithoutExpenseCategoriesInput {
...
export { ExpenseUpdateManyWithoutExpenseCategoriesInput as ExpenseUpdateManyWithoutExpenseCategoriesInput };
