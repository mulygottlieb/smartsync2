...
@InputType()
class FeatureOrganizationCreateNestedManyWithoutFeaturesInput {
...
export { FeatureOrganizationCreateNestedManyWithoutFeaturesInput as FeatureOrganizationCreateNestedManyWithoutFeaturesInput };
