...
@InputType()
class FeatureOrganizationUpdateManyWithoutFeaturesInput {
...
export { FeatureOrganizationUpdateManyWithoutFeaturesInput as FeatureOrganizationUpdateManyWithoutFeaturesInput };
