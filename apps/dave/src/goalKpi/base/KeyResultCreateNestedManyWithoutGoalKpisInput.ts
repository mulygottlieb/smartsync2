...
@InputType()
class KeyResultCreateNestedManyWithoutGoalKpisInput {
...
export { KeyResultCreateNestedManyWithoutGoalKpisInput as KeyResultCreateNestedManyWithoutGoalKpisInput };
