...
@InputType()
class EquipmentCreateNestedManyWithoutImageAssetsInput {
...
export { EquipmentCreateNestedManyWithoutImageAssetsInput as EquipmentCreateNestedManyWithoutImageAssetsInput };
