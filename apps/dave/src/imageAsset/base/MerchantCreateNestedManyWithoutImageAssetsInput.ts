...
@InputType()
class MerchantCreateNestedManyWithoutImageAssetsInput {
...
export { MerchantCreateNestedManyWithoutImageAssetsInput as MerchantCreateNestedManyWithoutImageAssetsInput };
