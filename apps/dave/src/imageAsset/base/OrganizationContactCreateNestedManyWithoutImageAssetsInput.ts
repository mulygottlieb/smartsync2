...
@InputType()
class OrganizationContactCreateNestedManyWithoutImageAssetsInput {
...
export { OrganizationContactCreateNestedManyWithoutImageAssetsInput as OrganizationContactCreateNestedManyWithoutImageAssetsInput };
