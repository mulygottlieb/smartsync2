...
@InputType()
class OrganizationProjectCreateNestedManyWithoutImageAssetsInput {
...
export { OrganizationProjectCreateNestedManyWithoutImageAssetsInput as OrganizationProjectCreateNestedManyWithoutImageAssetsInput };
