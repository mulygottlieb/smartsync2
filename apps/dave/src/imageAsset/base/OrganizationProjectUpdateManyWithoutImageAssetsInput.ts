...
@InputType()
class OrganizationProjectUpdateManyWithoutImageAssetsInput {
...
export { OrganizationProjectUpdateManyWithoutImageAssetsInput as OrganizationProjectUpdateManyWithoutImageAssetsInput };
