...
@InputType()
class OrganizationTeamCreateNestedManyWithoutImageAssetsInput {
...
export { OrganizationTeamCreateNestedManyWithoutImageAssetsInput as OrganizationTeamCreateNestedManyWithoutImageAssetsInput };
