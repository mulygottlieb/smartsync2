...
@InputType()
class ProductCategoryCreateNestedManyWithoutImageAssetsInput {
...
export { ProductCategoryCreateNestedManyWithoutImageAssetsInput as ProductCategoryCreateNestedManyWithoutImageAssetsInput };
