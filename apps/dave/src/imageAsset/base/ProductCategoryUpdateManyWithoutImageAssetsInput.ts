...
@InputType()
class ProductCategoryUpdateManyWithoutImageAssetsInput {
...
export { ProductCategoryUpdateManyWithoutImageAssetsInput as ProductCategoryUpdateManyWithoutImageAssetsInput };
