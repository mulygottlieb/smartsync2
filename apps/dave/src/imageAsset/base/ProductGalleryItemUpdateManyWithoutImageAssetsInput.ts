...
@InputType()
class ProductGalleryItemUpdateManyWithoutImageAssetsInput {
...
export { ProductGalleryItemUpdateManyWithoutImageAssetsInput as ProductGalleryItemUpdateManyWithoutImageAssetsInput };
