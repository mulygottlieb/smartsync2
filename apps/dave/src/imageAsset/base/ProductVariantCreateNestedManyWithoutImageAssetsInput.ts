...
@InputType()
class ProductVariantCreateNestedManyWithoutImageAssetsInput {
...
export { ProductVariantCreateNestedManyWithoutImageAssetsInput as ProductVariantCreateNestedManyWithoutImageAssetsInput };
