...
@InputType()
class ProductVariantUpdateManyWithoutImageAssetsInput {
...
export { ProductVariantUpdateManyWithoutImageAssetsInput as ProductVariantUpdateManyWithoutImageAssetsInput };
