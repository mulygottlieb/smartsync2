...
@InputType()
class WarehouseCreateNestedManyWithoutImageAssetsInput {
...
export { WarehouseCreateNestedManyWithoutImageAssetsInput as WarehouseCreateNestedManyWithoutImageAssetsInput };
