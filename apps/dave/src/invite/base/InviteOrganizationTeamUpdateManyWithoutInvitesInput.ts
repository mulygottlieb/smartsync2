...
@InputType()
class InviteOrganizationTeamUpdateManyWithoutInvitesInput {
...
export { InviteOrganizationTeamUpdateManyWithoutInvitesInput as InviteOrganizationTeamUpdateManyWithoutInvitesInput };
