...
@InputType()
class TagInvoiceCreateNestedManyWithoutInvoicesInput {
...
export { TagInvoiceCreateNestedManyWithoutInvoicesInput as TagInvoiceCreateNestedManyWithoutInvoicesInput };
