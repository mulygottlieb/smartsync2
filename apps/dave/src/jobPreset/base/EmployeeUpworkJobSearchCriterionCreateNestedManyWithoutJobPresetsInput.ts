...
@InputType()
class EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutJobPresetsInput {
...
export { EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutJobPresetsInput as EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutJobPresetsInput };
