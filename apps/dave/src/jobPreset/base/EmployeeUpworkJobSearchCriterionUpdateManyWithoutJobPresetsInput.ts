...
@InputType()
class EmployeeUpworkJobSearchCriterionUpdateManyWithoutJobPresetsInput {
...
export { EmployeeUpworkJobSearchCriterionUpdateManyWithoutJobPresetsInput as EmployeeUpworkJobSearchCriterionUpdateManyWithoutJobPresetsInput };
