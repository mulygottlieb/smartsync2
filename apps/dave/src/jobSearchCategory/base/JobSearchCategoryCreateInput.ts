...
@InputType()
class JobSearchCategoryCreateInput {
  @ApiProperty({
    required: true,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutJobSearchCategoriesInput,
  })
  @ValidateNested()
  @Type(
    () =>
  ...
  @ApiProperty({
    required: false,
    type: () =>
      JobPresetUpworkJobSearchCriterionCreateNestedManyWithoutJobSearchCategoriesInput,
  })
  @ValidateNested()
  @Type(
    () =>
...
export { JobSearchCategoryCreateInput as JobSearchCategoryCreateInput };
