...
@InputType()
class KeyResultUpdateCreateNestedManyWithoutKeyResultsInput {
...
export { KeyResultUpdateCreateNestedManyWithoutKeyResultsInput as KeyResultUpdateCreateNestedManyWithoutKeyResultsInput };
