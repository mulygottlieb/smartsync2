...
@InputType()
class KeyResultUpdateUpdateManyWithoutKeyResultsInput {
...
export { KeyResultUpdateUpdateManyWithoutKeyResultsInput as KeyResultUpdateUpdateManyWithoutKeyResultsInput };
