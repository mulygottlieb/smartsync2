...
@InputType()
class KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput {
...
export { KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput as KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput };
