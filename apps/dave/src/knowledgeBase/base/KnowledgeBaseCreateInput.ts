...
class KnowledgeBaseCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput,
  })
  @ValidateNested()
  @Type(() => KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput)
  @IsOptional()
  @Field(() => KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput,
  })
  @ValidateNested()
  @Type(() => KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput)
  @IsOptional()
  @Field(() => KnowledgeBaseArticleCreateNestedManyWithoutKnowledgeBasesInput, {
    nullable: true,
  })
