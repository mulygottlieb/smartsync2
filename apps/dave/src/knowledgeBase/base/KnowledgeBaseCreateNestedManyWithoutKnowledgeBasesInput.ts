...
@InputType()
class KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput {
...
export { KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput as KnowledgeBaseCreateNestedManyWithoutKnowledgeBasesInput };
