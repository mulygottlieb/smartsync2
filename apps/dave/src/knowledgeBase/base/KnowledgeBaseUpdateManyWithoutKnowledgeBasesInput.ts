...
@InputType()
class KnowledgeBaseUpdateManyWithoutKnowledgeBasesInput {
...
export { KnowledgeBaseUpdateManyWithoutKnowledgeBasesInput as KnowledgeBaseUpdateManyWithoutKnowledgeBasesInput };
