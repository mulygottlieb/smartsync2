...
@InputType()
class ActivityCreateNestedManyWithoutOrganizationsInput {
...
export { ActivityCreateNestedManyWithoutOrganizationsInput as ActivityCreateNestedManyWithoutOrganizationsInput };
