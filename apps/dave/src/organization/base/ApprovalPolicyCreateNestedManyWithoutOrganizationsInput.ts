...
@InputType()
class ApprovalPolicyCreateNestedManyWithoutOrganizationsInput {
...
export { ApprovalPolicyCreateNestedManyWithoutOrganizationsInput as ApprovalPolicyCreateNestedManyWithoutOrganizationsInput };
