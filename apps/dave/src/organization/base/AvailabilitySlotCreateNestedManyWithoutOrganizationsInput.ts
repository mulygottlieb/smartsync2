...
@InputType()
class AvailabilitySlotCreateNestedManyWithoutOrganizationsInput {
...
export { AvailabilitySlotCreateNestedManyWithoutOrganizationsInput as AvailabilitySlotCreateNestedManyWithoutOrganizationsInput };
