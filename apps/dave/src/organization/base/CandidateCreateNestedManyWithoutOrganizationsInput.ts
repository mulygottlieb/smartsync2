...
@InputType()
class CandidateCreateNestedManyWithoutOrganizationsInput {
...
export { CandidateCreateNestedManyWithoutOrganizationsInput as CandidateCreateNestedManyWithoutOrganizationsInput };
