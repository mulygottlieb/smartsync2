...
@InputType()
class CandidateCriterionRatingCreateNestedManyWithoutOrganizationsInput {
...
export { CandidateCriterionRatingCreateNestedManyWithoutOrganizationsInput as CandidateCriterionRatingCreateNestedManyWithoutOrganizationsInput };
