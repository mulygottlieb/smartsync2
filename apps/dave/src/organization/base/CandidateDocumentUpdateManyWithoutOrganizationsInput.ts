...
@InputType()
class CandidateDocumentUpdateManyWithoutOrganizationsInput {
...
export { CandidateDocumentUpdateManyWithoutOrganizationsInput as CandidateDocumentUpdateManyWithoutOrganizationsInput };
