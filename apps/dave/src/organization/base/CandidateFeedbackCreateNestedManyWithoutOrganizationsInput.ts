...
@InputType()
class CandidateFeedbackCreateNestedManyWithoutOrganizationsInput {
...
export { CandidateFeedbackCreateNestedManyWithoutOrganizationsInput as CandidateFeedbackCreateNestedManyWithoutOrganizationsInput };
