...
@InputType()
class CandidateInterviewerCreateNestedManyWithoutOrganizationsInput {
...
export { CandidateInterviewerCreateNestedManyWithoutOrganizationsInput as CandidateInterviewerCreateNestedManyWithoutOrganizationsInput };
