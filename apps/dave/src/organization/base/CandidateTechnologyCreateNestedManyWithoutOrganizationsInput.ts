...
@InputType()
class CandidateTechnologyCreateNestedManyWithoutOrganizationsInput {
...
export { CandidateTechnologyCreateNestedManyWithoutOrganizationsInput as CandidateTechnologyCreateNestedManyWithoutOrganizationsInput };
