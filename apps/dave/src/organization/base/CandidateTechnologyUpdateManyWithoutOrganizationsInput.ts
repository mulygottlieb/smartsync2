...
@InputType()
class CandidateTechnologyUpdateManyWithoutOrganizationsInput {
...
export { CandidateTechnologyUpdateManyWithoutOrganizationsInput as CandidateTechnologyUpdateManyWithoutOrganizationsInput };
