...
@InputType()
class EmployeeAppointmentCreateNestedManyWithoutOrganizationsInput {
...
export { EmployeeAppointmentCreateNestedManyWithoutOrganizationsInput as EmployeeAppointmentCreateNestedManyWithoutOrganizationsInput };
