...
@InputType()
class EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutOrganizationsInput {
...
export { EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutOrganizationsInput as EmployeeUpworkJobSearchCriterionCreateNestedManyWithoutOrganizationsInput };
