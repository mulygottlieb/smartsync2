...
@InputType()
class EmployeeUpworkJobSearchCriterionUpdateManyWithoutOrganizationsInput {
...
export { EmployeeUpworkJobSearchCriterionUpdateManyWithoutOrganizationsInput as EmployeeUpworkJobSearchCriterionUpdateManyWithoutOrganizationsInput };
