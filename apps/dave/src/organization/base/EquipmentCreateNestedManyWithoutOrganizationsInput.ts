...
@InputType()
class EquipmentCreateNestedManyWithoutOrganizationsInput {
...
export { EquipmentCreateNestedManyWithoutOrganizationsInput as EquipmentCreateNestedManyWithoutOrganizationsInput };
