...
@InputType()
class EquipmentSharingCreateNestedManyWithoutOrganizationsInput {
...
export { EquipmentSharingCreateNestedManyWithoutOrganizationsInput as EquipmentSharingCreateNestedManyWithoutOrganizationsInput };
