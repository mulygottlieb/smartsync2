...
@InputType()
class EquipmentSharingPolicyCreateNestedManyWithoutOrganizationsInput {
...
export { EquipmentSharingPolicyCreateNestedManyWithoutOrganizationsInput as EquipmentSharingPolicyCreateNestedManyWithoutOrganizationsInput };
