...
@InputType()
class ExpenseCategoryUpdateManyWithoutOrganizationsInput {
...
export { ExpenseCategoryUpdateManyWithoutOrganizationsInput as ExpenseCategoryUpdateManyWithoutOrganizationsInput };
