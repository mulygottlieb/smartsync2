...
@InputType()
class FeatureOrganizationCreateNestedManyWithoutOrganizationsInput {
...
export { FeatureOrganizationCreateNestedManyWithoutOrganizationsInput as FeatureOrganizationCreateNestedManyWithoutOrganizationsInput };
