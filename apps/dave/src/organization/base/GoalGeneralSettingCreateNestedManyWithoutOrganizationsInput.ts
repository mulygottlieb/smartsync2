...
@InputType()
class GoalGeneralSettingCreateNestedManyWithoutOrganizationsInput {
...
export { GoalGeneralSettingCreateNestedManyWithoutOrganizationsInput as GoalGeneralSettingCreateNestedManyWithoutOrganizationsInput };
