...
@InputType()
class GoalGeneralSettingUpdateManyWithoutOrganizationsInput {
...
export { GoalGeneralSettingUpdateManyWithoutOrganizationsInput as GoalGeneralSettingUpdateManyWithoutOrganizationsInput };
