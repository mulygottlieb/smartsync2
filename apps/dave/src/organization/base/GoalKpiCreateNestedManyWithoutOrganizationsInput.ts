...
@InputType()
class GoalKpiCreateNestedManyWithoutOrganizationsInput {
...
export { GoalKpiCreateNestedManyWithoutOrganizationsInput as GoalKpiCreateNestedManyWithoutOrganizationsInput };
