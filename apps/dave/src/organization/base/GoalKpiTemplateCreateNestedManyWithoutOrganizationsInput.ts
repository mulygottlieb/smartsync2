...
@InputType()
class GoalKpiTemplateCreateNestedManyWithoutOrganizationsInput {
...
export { GoalKpiTemplateCreateNestedManyWithoutOrganizationsInput as GoalKpiTemplateCreateNestedManyWithoutOrganizationsInput };
