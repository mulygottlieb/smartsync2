...
@InputType()
class GoalTemplateCreateNestedManyWithoutOrganizationsInput {
...
export { GoalTemplateCreateNestedManyWithoutOrganizationsInput as GoalTemplateCreateNestedManyWithoutOrganizationsInput };
