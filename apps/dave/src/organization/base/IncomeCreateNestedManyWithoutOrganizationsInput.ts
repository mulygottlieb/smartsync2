...
@InputType()
class IncomeCreateNestedManyWithoutOrganizationsInput {
...
export { IncomeCreateNestedManyWithoutOrganizationsInput as IncomeCreateNestedManyWithoutOrganizationsInput };
