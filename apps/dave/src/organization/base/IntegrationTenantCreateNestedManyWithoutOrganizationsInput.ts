...
@InputType()
class IntegrationTenantCreateNestedManyWithoutOrganizationsInput {
...
export { IntegrationTenantCreateNestedManyWithoutOrganizationsInput as IntegrationTenantCreateNestedManyWithoutOrganizationsInput };
