...
@InputType()
class IntegrationTenantUpdateManyWithoutOrganizationsInput {
...
export { IntegrationTenantUpdateManyWithoutOrganizationsInput as IntegrationTenantUpdateManyWithoutOrganizationsInput };
