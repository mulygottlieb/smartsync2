...
@InputType()
class InviteCreateNestedManyWithoutOrganizationsInput {
...
export { InviteCreateNestedManyWithoutOrganizationsInput as InviteCreateNestedManyWithoutOrganizationsInput };
