...
@InputType()
class InvoiceCreateNestedManyWithoutOrganizationsInput {
...
export { InvoiceCreateNestedManyWithoutOrganizationsInput as InvoiceCreateNestedManyWithoutOrganizationsInput };
