...
@InputType()
class InvoiceEstimateHistoryCreateNestedManyWithoutOrganizationsInput {
...
export { InvoiceEstimateHistoryCreateNestedManyWithoutOrganizationsInput as InvoiceEstimateHistoryCreateNestedManyWithoutOrganizationsInput };
