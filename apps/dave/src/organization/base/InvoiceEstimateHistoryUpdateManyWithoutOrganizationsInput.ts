...
@InputType()
class InvoiceEstimateHistoryUpdateManyWithoutOrganizationsInput {
...
export { InvoiceEstimateHistoryUpdateManyWithoutOrganizationsInput as InvoiceEstimateHistoryUpdateManyWithoutOrganizationsInput };
