...
@InputType()
class InvoiceItemCreateNestedManyWithoutOrganizationsInput {
...
export { InvoiceItemCreateNestedManyWithoutOrganizationsInput as InvoiceItemCreateNestedManyWithoutOrganizationsInput };
