...
@InputType()
class InvoiceItemUpdateManyWithoutOrganizationsInput {
...
export { InvoiceItemUpdateManyWithoutOrganizationsInput as InvoiceItemUpdateManyWithoutOrganizationsInput };
