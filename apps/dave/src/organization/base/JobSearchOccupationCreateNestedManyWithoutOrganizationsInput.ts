...
@InputType()
class JobSearchOccupationCreateNestedManyWithoutOrganizationsInput {
...
export { JobSearchOccupationCreateNestedManyWithoutOrganizationsInput as JobSearchOccupationCreateNestedManyWithoutOrganizationsInput };
