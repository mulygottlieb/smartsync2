...
@InputType()
class KeyResultCreateNestedManyWithoutOrganizationsInput {
...
export { KeyResultCreateNestedManyWithoutOrganizationsInput as KeyResultCreateNestedManyWithoutOrganizationsInput };
