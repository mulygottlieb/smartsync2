...
@InputType()
class KeyResultUpdateCreateNestedManyWithoutOrganizationsInput {
...
export { KeyResultUpdateCreateNestedManyWithoutOrganizationsInput as KeyResultUpdateCreateNestedManyWithoutOrganizationsInput };
