...
@InputType()
class KeyResultUpdateUpdateManyWithoutOrganizationsInput {
...
export { KeyResultUpdateUpdateManyWithoutOrganizationsInput as KeyResultUpdateUpdateManyWithoutOrganizationsInput };
