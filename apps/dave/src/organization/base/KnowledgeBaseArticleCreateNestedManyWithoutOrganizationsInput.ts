...
@InputType()
class KnowledgeBaseArticleCreateNestedManyWithoutOrganizationsInput {
...
export { KnowledgeBaseArticleCreateNestedManyWithoutOrganizationsInput as KnowledgeBaseArticleCreateNestedManyWithoutOrganizationsInput };
