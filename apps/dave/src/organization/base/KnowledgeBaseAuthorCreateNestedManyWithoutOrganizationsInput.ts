...
@InputType()
class KnowledgeBaseAuthorCreateNestedManyWithoutOrganizationsInput {
...
export { KnowledgeBaseAuthorCreateNestedManyWithoutOrganizationsInput as KnowledgeBaseAuthorCreateNestedManyWithoutOrganizationsInput };
