...
@InputType()
class KnowledgeBaseAuthorUpdateManyWithoutOrganizationsInput {
...
export { KnowledgeBaseAuthorUpdateManyWithoutOrganizationsInput as KnowledgeBaseAuthorUpdateManyWithoutOrganizationsInput };
