...
@InputType()
class KnowledgeBaseCreateNestedManyWithoutOrganizationsInput {
...
export { KnowledgeBaseCreateNestedManyWithoutOrganizationsInput as KnowledgeBaseCreateNestedManyWithoutOrganizationsInput };
