...
@InputType()
class MerchantCreateNestedManyWithoutOrganizationsInput {
...
export { MerchantCreateNestedManyWithoutOrganizationsInput as MerchantCreateNestedManyWithoutOrganizationsInput };
