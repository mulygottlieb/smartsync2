...
@InputType()
class OrganizationContactCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationContactCreateNestedManyWithoutOrganizationsInput as OrganizationContactCreateNestedManyWithoutOrganizationsInput };
