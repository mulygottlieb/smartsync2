...
@InputType()
class OrganizationContactUpdateManyWithoutOrganizationsInput {
...
export { OrganizationContactUpdateManyWithoutOrganizationsInput as OrganizationContactUpdateManyWithoutOrganizationsInput };
