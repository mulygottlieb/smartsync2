...
@InputType()
class OrganizationEmploymentTypeCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationEmploymentTypeCreateNestedManyWithoutOrganizationsInput as OrganizationEmploymentTypeCreateNestedManyWithoutOrganizationsInput };
