...
@InputType()
class OrganizationProjectCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationProjectCreateNestedManyWithoutOrganizationsInput as OrganizationProjectCreateNestedManyWithoutOrganizationsInput };
