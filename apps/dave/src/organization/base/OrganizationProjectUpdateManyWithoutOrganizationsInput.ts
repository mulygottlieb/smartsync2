...
@InputType()
class OrganizationProjectUpdateManyWithoutOrganizationsInput {
...
export { OrganizationProjectUpdateManyWithoutOrganizationsInput as OrganizationProjectUpdateManyWithoutOrganizationsInput };
