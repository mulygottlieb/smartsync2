...
@InputType()
class OrganizationRecurringExpenseCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationRecurringExpenseCreateNestedManyWithoutOrganizationsInput as OrganizationRecurringExpenseCreateNestedManyWithoutOrganizationsInput };
