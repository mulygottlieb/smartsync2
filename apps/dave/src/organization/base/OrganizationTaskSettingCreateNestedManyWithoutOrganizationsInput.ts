...
@InputType()
class OrganizationTaskSettingCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationTaskSettingCreateNestedManyWithoutOrganizationsInput as OrganizationTaskSettingCreateNestedManyWithoutOrganizationsInput };
