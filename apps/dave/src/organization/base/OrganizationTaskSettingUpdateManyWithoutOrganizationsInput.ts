...
@InputType()
class OrganizationTaskSettingUpdateManyWithoutOrganizationsInput {
...
export { OrganizationTaskSettingUpdateManyWithoutOrganizationsInput as OrganizationTaskSettingUpdateManyWithoutOrganizationsInput };
