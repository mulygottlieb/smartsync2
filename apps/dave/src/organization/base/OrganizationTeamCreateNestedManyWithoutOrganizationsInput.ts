...
@InputType()
class OrganizationTeamCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationTeamCreateNestedManyWithoutOrganizationsInput as OrganizationTeamCreateNestedManyWithoutOrganizationsInput };
