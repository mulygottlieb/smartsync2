...
@InputType()
class OrganizationTeamUpdateManyWithoutOrganizationsInput {
...
export { OrganizationTeamUpdateManyWithoutOrganizationsInput as OrganizationTeamUpdateManyWithoutOrganizationsInput };
