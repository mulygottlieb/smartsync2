...
@InputType()
class PipelineCreateNestedManyWithoutOrganizationsInput {
...
export { PipelineCreateNestedManyWithoutOrganizationsInput as PipelineCreateNestedManyWithoutOrganizationsInput };
