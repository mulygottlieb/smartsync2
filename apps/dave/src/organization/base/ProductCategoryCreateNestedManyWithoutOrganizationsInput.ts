...
@InputType()
class ProductCategoryCreateNestedManyWithoutOrganizationsInput {
...
export { ProductCategoryCreateNestedManyWithoutOrganizationsInput as ProductCategoryCreateNestedManyWithoutOrganizationsInput };
