...
@InputType()
class ProductCategoryTranslationUpdateManyWithoutOrganizationsInput {
...
export { ProductCategoryTranslationUpdateManyWithoutOrganizationsInput as ProductCategoryTranslationUpdateManyWithoutOrganizationsInput };
