...
@InputType()
class ProductOptionCreateNestedManyWithoutOrganizationsInput {
...
export { ProductOptionCreateNestedManyWithoutOrganizationsInput as ProductOptionCreateNestedManyWithoutOrganizationsInput };
