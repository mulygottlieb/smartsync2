...
@InputType()
class ProductOptionGroupCreateNestedManyWithoutOrganizationsInput {
...
export { ProductOptionGroupCreateNestedManyWithoutOrganizationsInput as ProductOptionGroupCreateNestedManyWithoutOrganizationsInput };
