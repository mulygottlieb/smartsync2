...
@InputType()
class ProductOptionGroupTranslationCreateNestedManyWithoutOrganizationsInput {
...
export { ProductOptionGroupTranslationCreateNestedManyWithoutOrganizationsInput as ProductOptionGroupTranslationCreateNestedManyWithoutOrganizationsInput };
