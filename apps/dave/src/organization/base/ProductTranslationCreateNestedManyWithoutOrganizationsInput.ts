...
@InputType()
class ProductTranslationCreateNestedManyWithoutOrganizationsInput {
...
export { ProductTranslationCreateNestedManyWithoutOrganizationsInput as ProductTranslationCreateNestedManyWithoutOrganizationsInput };
