...
@InputType()
class ProductTranslationUpdateManyWithoutOrganizationsInput {
...
export { ProductTranslationUpdateManyWithoutOrganizationsInput as ProductTranslationUpdateManyWithoutOrganizationsInput };
