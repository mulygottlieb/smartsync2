...
@InputType()
class ProductTypeCreateNestedManyWithoutOrganizationsInput {
...
export { ProductTypeCreateNestedManyWithoutOrganizationsInput as ProductTypeCreateNestedManyWithoutOrganizationsInput };
