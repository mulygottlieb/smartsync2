...
@InputType()
class ProductVariantCreateNestedManyWithoutOrganizationsInput {
...
export { ProductVariantCreateNestedManyWithoutOrganizationsInput as ProductVariantCreateNestedManyWithoutOrganizationsInput };
