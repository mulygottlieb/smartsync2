...
@InputType()
class ProductVariantPriceCreateNestedManyWithoutOrganizationsInput {
...
export { ProductVariantPriceCreateNestedManyWithoutOrganizationsInput as ProductVariantPriceCreateNestedManyWithoutOrganizationsInput };
