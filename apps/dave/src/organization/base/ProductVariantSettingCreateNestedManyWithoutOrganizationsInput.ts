...
@InputType()
class ProductVariantSettingCreateNestedManyWithoutOrganizationsInput {
...
export { ProductVariantSettingCreateNestedManyWithoutOrganizationsInput as ProductVariantSettingCreateNestedManyWithoutOrganizationsInput };
