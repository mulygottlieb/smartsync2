...
@InputType()
class ProductVariantSettingUpdateManyWithoutOrganizationsInput {
...
export { ProductVariantSettingUpdateManyWithoutOrganizationsInput as ProductVariantSettingUpdateManyWithoutOrganizationsInput };
