...
@InputType()
class ProductVariantUpdateManyWithoutOrganizationsInput {
...
export { ProductVariantUpdateManyWithoutOrganizationsInput as ProductVariantUpdateManyWithoutOrganizationsInput };
