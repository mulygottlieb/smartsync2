...
@InputType()
class ProposalCreateNestedManyWithoutOrganizationsInput {
...
export { ProposalCreateNestedManyWithoutOrganizationsInput as ProposalCreateNestedManyWithoutOrganizationsInput };
