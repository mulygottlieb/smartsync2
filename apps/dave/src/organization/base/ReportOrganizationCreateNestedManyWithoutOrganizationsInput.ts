...
@InputType()
class ReportOrganizationCreateNestedManyWithoutOrganizationsInput {
...
export { ReportOrganizationCreateNestedManyWithoutOrganizationsInput as ReportOrganizationCreateNestedManyWithoutOrganizationsInput };
