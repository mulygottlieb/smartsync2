...
@InputType()
class TaskPriorityCreateNestedManyWithoutOrganizationsInput {
...
export { TaskPriorityCreateNestedManyWithoutOrganizationsInput as TaskPriorityCreateNestedManyWithoutOrganizationsInput };
