...
@InputType()
class TimeLogCreateNestedManyWithoutOrganizationsInput {
...
export { TimeLogCreateNestedManyWithoutOrganizationsInput as TimeLogCreateNestedManyWithoutOrganizationsInput };
