...
@InputType()
class TimeOffPolicyCreateNestedManyWithoutOrganizationsInput {
...
export { TimeOffPolicyCreateNestedManyWithoutOrganizationsInput as TimeOffPolicyCreateNestedManyWithoutOrganizationsInput };
