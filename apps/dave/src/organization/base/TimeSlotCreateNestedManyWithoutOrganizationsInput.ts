...
@InputType()
class TimeSlotCreateNestedManyWithoutOrganizationsInput {
...
export { TimeSlotCreateNestedManyWithoutOrganizationsInput as TimeSlotCreateNestedManyWithoutOrganizationsInput };
