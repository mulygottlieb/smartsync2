...
@InputType()
class TimesheetCreateNestedManyWithoutOrganizationsInput {
...
export { TimesheetCreateNestedManyWithoutOrganizationsInput as TimesheetCreateNestedManyWithoutOrganizationsInput };
