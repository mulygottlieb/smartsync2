...
@InputType()
class WarehouseCreateNestedManyWithoutOrganizationsInput {
...
export { WarehouseCreateNestedManyWithoutOrganizationsInput as WarehouseCreateNestedManyWithoutOrganizationsInput };
