...
@InputType()
class WarehouseProductUpdateManyWithoutOrganizationsInput {
...
export { WarehouseProductUpdateManyWithoutOrganizationsInput as WarehouseProductUpdateManyWithoutOrganizationsInput };
