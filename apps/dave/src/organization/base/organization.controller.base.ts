...
export class OrganizationControllerBase {
    ...
    return await this.service.create({
      data: {
        ...
        contactOrganizationContactIdTocontact:
          data.contactOrganizationContactIdTocontact
            ? {
                connect: data.contactOrganizationContactIdTocontact,
              }
            : undefined,

        imageAssetOrganizationImageIdToimageAsset:
          data.imageAssetOrganizationImageIdToimageAsset
            ? {
                connect: data.imageAssetOrganizationImageIdToimageAsset,
              }
            : undefined,
  ...
  @common.Get("/:id/contactContactOrganizationIdToorganization")
  @ApiNestedQuery(ContactFindManyArgs)
  async findManyContactContactOrganizationIdToorganization(
    @common.Req() request: Request,
    @common.Param() params: OrganizationWhereUniqueInput
  ): Promise<Contact[]> {
    const query = plainToClass(ContactFindManyArgs, request.query);
    const results =
      await this.service.findContactContactOrganizationIdToorganization(
        params.id,
        {
          ...query,
          select: {
  ...
  @common.Post("/:id/contactContactOrganizationIdToorganization")
  async connectContactContactOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ContactWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      contactContactOrganizationIdToorganization: {
        connect: body,
      },
    };
    await this.service.update({
  ...
  @common.Patch("/:id/contactContactOrganizationIdToorganization")
  async updateContactContactOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ContactWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/contactContactOrganizationIdToorganization")
  async disconnectContactContactOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ContactWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Get("/:id/imageAssetImageAssetOrganizationIdToorganization")
  @ApiNestedQuery(ImageAssetFindManyArgs)
  async findManyImageAssetImageAssetOrganizationIdToorganization(
    @common.Req() request: Request,
    @common.Param() params: OrganizationWhereUniqueInput
  ): Promise<ImageAsset[]> {
    const query = plainToClass(ImageAssetFindManyArgs, request.query);
    const results =
      await this.service.findImageAssetImageAssetOrganizationIdToorganization(
        params.id,
        {
          ...query,
          select: {
  ...
  @common.Post("/:id/imageAssetImageAssetOrganizationIdToorganization")
  async connectImageAssetImageAssetOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ImageAssetWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      imageAssetImageAssetOrganizationIdToorganization: {
        connect: body,
      },
    };
    await this.service.update({
  ...
  @common.Patch("/:id/imageAssetImageAssetOrganizationIdToorganization")
  async updateImageAssetImageAssetOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ImageAssetWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/imageAssetImageAssetOrganizationIdToorganization")
  async disconnectImageAssetImageAssetOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: ImageAssetWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Get("/:id/invoiceInvoiceFromOrganizationIdToorganization")
  @ApiNestedQuery(InvoiceFindManyArgs)
  async findManyInvoiceInvoiceFromOrganizationIdToorganization(
    @common.Req() request: Request,
    @common.Param() params: OrganizationWhereUniqueInput
  ): Promise<Invoice[]> {
    const query = plainToClass(InvoiceFindManyArgs, request.query);
    const results =
      await this.service.findInvoiceInvoiceFromOrganizationIdToorganization(
        params.id,
        {
          ...query,
          select: {
  ...
  @common.Post("/:id/invoiceInvoiceFromOrganizationIdToorganization")
  async connectInvoiceInvoiceFromOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      invoiceInvoiceFromOrganizationIdToorganization: {
        connect: body,
      },
    };
    await this.service.update({
  ...
  @common.Patch("/:id/invoiceInvoiceFromOrganizationIdToorganization")
  async updateInvoiceInvoiceFromOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/invoiceInvoiceFromOrganizationIdToorganization")
  async disconnectInvoiceInvoiceFromOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Get("/:id/invoiceInvoiceOrganizationIdToorganization")
  @ApiNestedQuery(InvoiceFindManyArgs)
  async findManyInvoiceInvoiceOrganizationIdToorganization(
    @common.Req() request: Request,
    @common.Param() params: OrganizationWhereUniqueInput
  ): Promise<Invoice[]> {
    const query = plainToClass(InvoiceFindManyArgs, request.query);
    const results =
      await this.service.findInvoiceInvoiceOrganizationIdToorganization(
        params.id,
        {
          ...query,
          select: {
  ...
  @common.Post("/:id/invoiceInvoiceOrganizationIdToorganization")
  async connectInvoiceInvoiceOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      invoiceInvoiceOrganizationIdToorganization: {
        connect: body,
      },
    };
    await this.service.update({
  ...
  @common.Patch("/:id/invoiceInvoiceOrganizationIdToorganization")
  async updateInvoiceInvoiceOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/invoiceInvoiceOrganizationIdToorganization")
  async disconnectInvoiceInvoiceOrganizationIdToorganization(
    @common.Param() params: OrganizationWhereUniqueInput,
    @common.Body() body: InvoiceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
