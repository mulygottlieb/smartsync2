...
export class OrganizationResolverBase {
  ...
  async createOrganization(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        contactOrganizationContactIdTocontact: args.data
          .contactOrganizationContactIdTocontact
          ? {
              connect: args.data.contactOrganizationContactIdTocontact,
            }
          : undefined,

        imageAssetOrganizationImageIdToimageAsset: args.data
          .imageAssetOrganizationImageIdToimageAsset
          ? {
              connect: args.data.imageAssetOrganizationImageIdToimageAsset,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => [Contact], {
    name: "contactContactOrganizationIdToorganization",
  })
  async resolveFieldContactContactOrganizationIdToorganization(
    @graphql.Parent() parent: Organization,
  ...
  @graphql.ResolveField(() => [ImageAsset], {
    name: "imageAssetImageAssetOrganizationIdToorganization",
  })
  async resolveFieldImageAssetImageAssetOrganizationIdToorganization(
    @graphql.Parent() parent: Organization,
  ...
  @graphql.ResolveField(() => [Invoice], {
    name: "invoiceInvoiceFromOrganizationIdToorganization",
  })
  async resolveFieldInvoiceInvoiceFromOrganizationIdToorganization(
    @graphql.Parent() parent: Organization,
  ...
  @graphql.ResolveField(() => [Invoice], {
    name: "invoiceInvoiceOrganizationIdToorganization",
  })
  async resolveFieldInvoiceInvoiceOrganizationIdToorganization(
    @graphql.Parent() parent: Organization,
    @graphql.Args() args: InvoiceFindManyArgs
  ): Promise<Invoice[]> {
    const results =
  ...
  @graphql.ResolveField(() => Contact, {
    nullable: true,
    name: "contactOrganizationContactIdTocontact",
  })
  async resolveFieldContactOrganizationContactIdTocontact(
    @graphql.Parent() parent: Organization
  ): Promise<Contact | null> {
    const result = await this.service.getContactOrganizationContactIdTocontact(
      parent.id
    );
  ...
  @graphql.ResolveField(() => ImageAsset, {
    nullable: true,
    name: "imageAssetOrganizationImageIdToimageAsset",
  })
  async resolveFieldImageAssetOrganizationImageIdToimageAsset(
    @graphql.Parent() parent: Organization
  ): Promise<ImageAsset | null> {
    const result =
      await this.service.getImageAssetOrganizationImageIdToimageAsset(
        parent.id
      );
