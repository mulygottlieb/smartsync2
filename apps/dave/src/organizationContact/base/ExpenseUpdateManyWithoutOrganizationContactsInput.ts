...
@InputType()
class ExpenseUpdateManyWithoutOrganizationContactsInput {
...
export { ExpenseUpdateManyWithoutOrganizationContactsInput as ExpenseUpdateManyWithoutOrganizationContactsInput };
