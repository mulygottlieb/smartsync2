...
@InputType()
class IncomeUpdateManyWithoutOrganizationContactsInput {
...
export { IncomeUpdateManyWithoutOrganizationContactsInput as IncomeUpdateManyWithoutOrganizationContactsInput };
