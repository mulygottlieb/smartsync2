...
@InputType()
class InvoiceUpdateManyWithoutOrganizationContactsInput {
...
export { InvoiceUpdateManyWithoutOrganizationContactsInput as InvoiceUpdateManyWithoutOrganizationContactsInput };
