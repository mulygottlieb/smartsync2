...
@InputType()
class ProposalUpdateManyWithoutOrganizationContactsInput {
...
export { ProposalUpdateManyWithoutOrganizationContactsInput as ProposalUpdateManyWithoutOrganizationContactsInput };
