...
const CREATE_INPUT = {
  ...
  primaryPhone: "examplePrimaryPhone",
  notes: "exampleNotes",
...
describe("OrganizationContact", () => {
  ...
  test("POST /organizationContacts", async () => {
  ...
  test("GET /organizationContacts", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /organizationContacts/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organizationContacts"}/${nonExistingId}`)
  ...
  test("GET /organizationContacts/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organizationContacts"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /organizationContacts existing resource", async () => {
