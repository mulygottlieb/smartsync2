...
@InputType()
class OrganizationEmploymentTypeEmployeeCreateInput {
  @ApiProperty({
    required: true,
...
export { OrganizationEmploymentTypeEmployeeCreateInput as OrganizationEmploymentTypeEmployeeCreateInput };
