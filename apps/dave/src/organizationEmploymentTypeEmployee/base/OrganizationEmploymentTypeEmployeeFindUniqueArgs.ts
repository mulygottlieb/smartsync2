...
@ArgsType()
class OrganizationEmploymentTypeEmployeeFindUniqueArgs {
  @ApiProperty({
    required: true,
...
export { OrganizationEmploymentTypeEmployeeFindUniqueArgs as OrganizationEmploymentTypeEmployeeFindUniqueArgs };
