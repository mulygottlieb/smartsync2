...
@InputType()
class CandidateUpdateManyWithoutOrganizationPositionsInput {
...
export { CandidateUpdateManyWithoutOrganizationPositionsInput as CandidateUpdateManyWithoutOrganizationPositionsInput };
