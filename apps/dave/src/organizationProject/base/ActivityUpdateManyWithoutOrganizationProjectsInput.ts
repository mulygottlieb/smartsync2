...
@InputType()
class ActivityUpdateManyWithoutOrganizationProjectsInput {
...
export { ActivityUpdateManyWithoutOrganizationProjectsInput as ActivityUpdateManyWithoutOrganizationProjectsInput };
