...
@InputType()
class ExpenseUpdateManyWithoutOrganizationProjectsInput {
...
export { ExpenseUpdateManyWithoutOrganizationProjectsInput as ExpenseUpdateManyWithoutOrganizationProjectsInput };
