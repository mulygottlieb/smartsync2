...
@InputType()
class IssueTypeUpdateManyWithoutOrganizationProjectsInput {
...
export { IssueTypeUpdateManyWithoutOrganizationProjectsInput as IssueTypeUpdateManyWithoutOrganizationProjectsInput };
