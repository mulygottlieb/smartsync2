...
@InputType()
class OrganizationSprintCreateNestedManyWithoutOrganizationProjectsInput {
...
export { OrganizationSprintCreateNestedManyWithoutOrganizationProjectsInput as OrganizationSprintCreateNestedManyWithoutOrganizationProjectsInput };
