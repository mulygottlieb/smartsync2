...
@InputType()
class OrganizationTaskSettingUpdateManyWithoutOrganizationProjectsInput {
...
export { OrganizationTaskSettingUpdateManyWithoutOrganizationProjectsInput as OrganizationTaskSettingUpdateManyWithoutOrganizationProjectsInput };
