...
@InputType()
class TaskPriorityUpdateManyWithoutOrganizationProjectsInput {
...
export { TaskPriorityUpdateManyWithoutOrganizationProjectsInput as TaskPriorityUpdateManyWithoutOrganizationProjectsInput };
