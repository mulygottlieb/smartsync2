...
@InputType()
class TaskUpdateManyWithoutOrganizationSprintsInput {
...
export { TaskUpdateManyWithoutOrganizationSprintsInput as TaskUpdateManyWithoutOrganizationSprintsInput };
