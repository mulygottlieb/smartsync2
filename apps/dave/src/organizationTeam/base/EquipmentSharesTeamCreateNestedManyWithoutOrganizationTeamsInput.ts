...
@InputType()
class EquipmentSharesTeamCreateNestedManyWithoutOrganizationTeamsInput {
...
export { EquipmentSharesTeamCreateNestedManyWithoutOrganizationTeamsInput as EquipmentSharesTeamCreateNestedManyWithoutOrganizationTeamsInput };
