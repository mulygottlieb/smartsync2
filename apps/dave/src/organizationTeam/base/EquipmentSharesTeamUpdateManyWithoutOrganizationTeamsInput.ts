...
@InputType()
class EquipmentSharesTeamUpdateManyWithoutOrganizationTeamsInput {
...
export { EquipmentSharesTeamUpdateManyWithoutOrganizationTeamsInput as EquipmentSharesTeamUpdateManyWithoutOrganizationTeamsInput };
