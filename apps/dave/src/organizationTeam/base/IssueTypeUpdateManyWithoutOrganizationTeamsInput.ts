...
@InputType()
class IssueTypeUpdateManyWithoutOrganizationTeamsInput {
...
export { IssueTypeUpdateManyWithoutOrganizationTeamsInput as IssueTypeUpdateManyWithoutOrganizationTeamsInput };
