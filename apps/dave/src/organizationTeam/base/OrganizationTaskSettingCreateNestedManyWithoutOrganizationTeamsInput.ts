...
@InputType()
class OrganizationTaskSettingCreateNestedManyWithoutOrganizationTeamsInput {
...
export { OrganizationTaskSettingCreateNestedManyWithoutOrganizationTeamsInput as OrganizationTaskSettingCreateNestedManyWithoutOrganizationTeamsInput };
