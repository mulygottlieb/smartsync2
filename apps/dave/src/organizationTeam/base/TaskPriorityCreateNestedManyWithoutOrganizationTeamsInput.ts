...
@InputType()
class TaskPriorityCreateNestedManyWithoutOrganizationTeamsInput {
...
export { TaskPriorityCreateNestedManyWithoutOrganizationTeamsInput as TaskPriorityCreateNestedManyWithoutOrganizationTeamsInput };
