...
@InputType()
class ExpenseUpdateManyWithoutOrganizationVendorsInput {
...
export { ExpenseUpdateManyWithoutOrganizationVendorsInput as ExpenseUpdateManyWithoutOrganizationVendorsInput };
