...
@InputType()
class OrganizationVendorCreateInput {
  @ApiProperty({
    required: true,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ExpenseCreateNestedManyWithoutOrganizationVendorsInput,
  })
  @ValidateNested()
  @Type(() => ExpenseCreateNestedManyWithoutOrganizationVendorsInput)
  @IsOptional()
  @Field(() => ExpenseCreateNestedManyWithoutOrganizationVendorsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      TagOrganizationVendorCreateNestedManyWithoutOrganizationVendorsInput,
  })
  @ValidateNested()
  @Type(
    () => TagOrganizationVendorCreateNestedManyWithoutOrganizationVendorsInput
...
export { OrganizationVendorCreateInput as OrganizationVendorCreateInput };
