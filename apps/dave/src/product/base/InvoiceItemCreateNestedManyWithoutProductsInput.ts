...
@InputType()
class InvoiceItemCreateNestedManyWithoutProductsInput {
...
export { InvoiceItemCreateNestedManyWithoutProductsInput as InvoiceItemCreateNestedManyWithoutProductsInput };
