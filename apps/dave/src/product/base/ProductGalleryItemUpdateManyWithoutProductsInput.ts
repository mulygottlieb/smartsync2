...
@InputType()
class ProductGalleryItemUpdateManyWithoutProductsInput {
...
export { ProductGalleryItemUpdateManyWithoutProductsInput as ProductGalleryItemUpdateManyWithoutProductsInput };
