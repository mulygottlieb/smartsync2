...
@InputType()
class ProductOptionGroupCreateNestedManyWithoutProductsInput {
...
export { ProductOptionGroupCreateNestedManyWithoutProductsInput as ProductOptionGroupCreateNestedManyWithoutProductsInput };
