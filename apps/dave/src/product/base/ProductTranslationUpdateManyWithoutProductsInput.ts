...
@InputType()
class ProductTranslationUpdateManyWithoutProductsInput {
...
export { ProductTranslationUpdateManyWithoutProductsInput as ProductTranslationUpdateManyWithoutProductsInput };
