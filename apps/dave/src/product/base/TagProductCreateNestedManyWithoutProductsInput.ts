...
@InputType()
class TagProductCreateNestedManyWithoutProductsInput {
...
export { TagProductCreateNestedManyWithoutProductsInput as TagProductCreateNestedManyWithoutProductsInput };
