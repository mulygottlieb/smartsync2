...
@InputType()
class WarehouseProductCreateNestedManyWithoutProductsInput {
...
export { WarehouseProductCreateNestedManyWithoutProductsInput as WarehouseProductCreateNestedManyWithoutProductsInput };
