...
@InputType()
class WarehouseProductUpdateManyWithoutProductsInput {
...
export { WarehouseProductUpdateManyWithoutProductsInput as WarehouseProductUpdateManyWithoutProductsInput };
