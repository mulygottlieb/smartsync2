...
@InputType()
class ProductOptionCreateNestedManyWithoutProductOptionGroupsInput {
...
export { ProductOptionCreateNestedManyWithoutProductOptionGroupsInput as ProductOptionCreateNestedManyWithoutProductOptionGroupsInput };
