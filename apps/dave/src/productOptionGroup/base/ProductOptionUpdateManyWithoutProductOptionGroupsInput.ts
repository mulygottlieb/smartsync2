...
@InputType()
class ProductOptionUpdateManyWithoutProductOptionGroupsInput {
...
export { ProductOptionUpdateManyWithoutProductOptionGroupsInput as ProductOptionUpdateManyWithoutProductOptionGroupsInput };
