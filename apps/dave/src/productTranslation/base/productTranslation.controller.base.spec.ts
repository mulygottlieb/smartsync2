...
describe("ProductTranslation", () => {
  ...
  test("POST /productTranslations", async () => {
  ...
  test("GET /productTranslations", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /productTranslations/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productTranslations"}/${nonExistingId}`)
  ...
  test("GET /productTranslations/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productTranslations"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /productTranslations existing resource", async () => {
