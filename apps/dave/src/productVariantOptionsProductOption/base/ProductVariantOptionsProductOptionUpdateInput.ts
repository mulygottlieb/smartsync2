...
@InputType()
class ProductVariantOptionsProductOptionUpdateInput {
  @ApiProperty({
    required: false,
...
export { ProductVariantOptionsProductOptionUpdateInput as ProductVariantOptionsProductOptionUpdateInput };
