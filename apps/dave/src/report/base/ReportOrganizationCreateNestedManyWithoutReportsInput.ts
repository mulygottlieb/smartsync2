...
@InputType()
class ReportOrganizationCreateNestedManyWithoutReportsInput {
...
export { ReportOrganizationCreateNestedManyWithoutReportsInput as ReportOrganizationCreateNestedManyWithoutReportsInput };
