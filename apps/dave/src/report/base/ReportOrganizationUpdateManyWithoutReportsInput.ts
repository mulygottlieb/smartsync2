...
@InputType()
class ReportOrganizationUpdateManyWithoutReportsInput {
...
export { ReportOrganizationUpdateManyWithoutReportsInput as ReportOrganizationUpdateManyWithoutReportsInput };
