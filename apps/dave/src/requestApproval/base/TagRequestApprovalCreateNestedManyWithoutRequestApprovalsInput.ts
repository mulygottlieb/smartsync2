...
@InputType()
class TagRequestApprovalCreateNestedManyWithoutRequestApprovalsInput {
...
export { TagRequestApprovalCreateNestedManyWithoutRequestApprovalsInput as TagRequestApprovalCreateNestedManyWithoutRequestApprovalsInput };
