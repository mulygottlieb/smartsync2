...
@InputType()
class TagOrganizationTeamCreateNestedManyWithoutTagsInput {
...
export { TagOrganizationTeamCreateNestedManyWithoutTagsInput as TagOrganizationTeamCreateNestedManyWithoutTagsInput };
