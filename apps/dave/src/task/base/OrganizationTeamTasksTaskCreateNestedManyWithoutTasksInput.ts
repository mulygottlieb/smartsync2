...
@InputType()
class OrganizationTeamTasksTaskCreateNestedManyWithoutTasksInput {
...
export { OrganizationTeamTasksTaskCreateNestedManyWithoutTasksInput as OrganizationTeamTasksTaskCreateNestedManyWithoutTasksInput };
