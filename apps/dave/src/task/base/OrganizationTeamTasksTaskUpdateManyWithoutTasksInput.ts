...
@InputType()
class OrganizationTeamTasksTaskUpdateManyWithoutTasksInput {
...
export { OrganizationTeamTasksTaskUpdateManyWithoutTasksInput as OrganizationTeamTasksTaskUpdateManyWithoutTasksInput };
