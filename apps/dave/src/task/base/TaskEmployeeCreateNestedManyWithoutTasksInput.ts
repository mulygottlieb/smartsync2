...
@InputType()
class TaskEmployeeCreateNestedManyWithoutTasksInput {
...
export { TaskEmployeeCreateNestedManyWithoutTasksInput as TaskEmployeeCreateNestedManyWithoutTasksInput };
