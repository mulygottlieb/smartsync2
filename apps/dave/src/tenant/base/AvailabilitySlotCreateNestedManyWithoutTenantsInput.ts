...
@InputType()
class AvailabilitySlotCreateNestedManyWithoutTenantsInput {
...
export { AvailabilitySlotCreateNestedManyWithoutTenantsInput as AvailabilitySlotCreateNestedManyWithoutTenantsInput };
