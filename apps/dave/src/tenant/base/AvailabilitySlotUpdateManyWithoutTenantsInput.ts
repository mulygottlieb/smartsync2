...
@InputType()
class AvailabilitySlotUpdateManyWithoutTenantsInput {
...
export { AvailabilitySlotUpdateManyWithoutTenantsInput as AvailabilitySlotUpdateManyWithoutTenantsInput };
