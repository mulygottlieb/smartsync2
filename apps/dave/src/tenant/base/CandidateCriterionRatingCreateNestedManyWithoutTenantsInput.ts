...
@InputType()
class CandidateCriterionRatingCreateNestedManyWithoutTenantsInput {
...
export { CandidateCriterionRatingCreateNestedManyWithoutTenantsInput as CandidateCriterionRatingCreateNestedManyWithoutTenantsInput };
