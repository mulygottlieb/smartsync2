...
@InputType()
class CandidateCriterionRatingUpdateManyWithoutTenantsInput {
...
export { CandidateCriterionRatingUpdateManyWithoutTenantsInput as CandidateCriterionRatingUpdateManyWithoutTenantsInput };
