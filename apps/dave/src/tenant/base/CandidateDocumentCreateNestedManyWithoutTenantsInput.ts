...
@InputType()
class CandidateDocumentCreateNestedManyWithoutTenantsInput {
...
export { CandidateDocumentCreateNestedManyWithoutTenantsInput as CandidateDocumentCreateNestedManyWithoutTenantsInput };
