...
@InputType()
class CandidateFeedbackCreateNestedManyWithoutTenantsInput {
...
export { CandidateFeedbackCreateNestedManyWithoutTenantsInput as CandidateFeedbackCreateNestedManyWithoutTenantsInput };
