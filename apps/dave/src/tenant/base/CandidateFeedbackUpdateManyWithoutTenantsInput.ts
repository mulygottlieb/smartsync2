...
@InputType()
class CandidateFeedbackUpdateManyWithoutTenantsInput {
...
export { CandidateFeedbackUpdateManyWithoutTenantsInput as CandidateFeedbackUpdateManyWithoutTenantsInput };
