...
@InputType()
class CandidateInterviewCreateNestedManyWithoutTenantsInput {
...
export { CandidateInterviewCreateNestedManyWithoutTenantsInput as CandidateInterviewCreateNestedManyWithoutTenantsInput };
