...
@InputType()
class CandidateInterviewerCreateNestedManyWithoutTenantsInput {
...
export { CandidateInterviewerCreateNestedManyWithoutTenantsInput as CandidateInterviewerCreateNestedManyWithoutTenantsInput };
