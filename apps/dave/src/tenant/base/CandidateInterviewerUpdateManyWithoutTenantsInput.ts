...
@InputType()
class CandidateInterviewerUpdateManyWithoutTenantsInput {
...
export { CandidateInterviewerUpdateManyWithoutTenantsInput as CandidateInterviewerUpdateManyWithoutTenantsInput };
