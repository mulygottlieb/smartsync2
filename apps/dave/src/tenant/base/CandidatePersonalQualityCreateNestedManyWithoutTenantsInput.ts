...
@InputType()
class CandidatePersonalQualityCreateNestedManyWithoutTenantsInput {
...
export { CandidatePersonalQualityCreateNestedManyWithoutTenantsInput as CandidatePersonalQualityCreateNestedManyWithoutTenantsInput };
