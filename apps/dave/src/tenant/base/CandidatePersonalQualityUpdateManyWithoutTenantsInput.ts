...
@InputType()
class CandidatePersonalQualityUpdateManyWithoutTenantsInput {
...
export { CandidatePersonalQualityUpdateManyWithoutTenantsInput as CandidatePersonalQualityUpdateManyWithoutTenantsInput };
