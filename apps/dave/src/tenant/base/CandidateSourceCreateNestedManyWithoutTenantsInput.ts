...
@InputType()
class CandidateSourceCreateNestedManyWithoutTenantsInput {
...
export { CandidateSourceCreateNestedManyWithoutTenantsInput as CandidateSourceCreateNestedManyWithoutTenantsInput };
