...
@InputType()
class CandidateTechnologyCreateNestedManyWithoutTenantsInput {
...
export { CandidateTechnologyCreateNestedManyWithoutTenantsInput as CandidateTechnologyCreateNestedManyWithoutTenantsInput };
