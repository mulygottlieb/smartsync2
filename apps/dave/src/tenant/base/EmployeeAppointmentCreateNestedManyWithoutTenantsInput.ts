...
@InputType()
class EmployeeAppointmentCreateNestedManyWithoutTenantsInput {
...
export { EmployeeAppointmentCreateNestedManyWithoutTenantsInput as EmployeeAppointmentCreateNestedManyWithoutTenantsInput };
