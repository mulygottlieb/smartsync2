...
@InputType()
class EmployeeAppointmentUpdateManyWithoutTenantsInput {
...
export { EmployeeAppointmentUpdateManyWithoutTenantsInput as EmployeeAppointmentUpdateManyWithoutTenantsInput };
