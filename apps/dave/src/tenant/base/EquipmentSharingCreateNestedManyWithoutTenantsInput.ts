...
@InputType()
class EquipmentSharingCreateNestedManyWithoutTenantsInput {
...
export { EquipmentSharingCreateNestedManyWithoutTenantsInput as EquipmentSharingCreateNestedManyWithoutTenantsInput };
