...
@InputType()
class GoalKpiTemplateCreateNestedManyWithoutTenantsInput {
...
export { GoalKpiTemplateCreateNestedManyWithoutTenantsInput as GoalKpiTemplateCreateNestedManyWithoutTenantsInput };
