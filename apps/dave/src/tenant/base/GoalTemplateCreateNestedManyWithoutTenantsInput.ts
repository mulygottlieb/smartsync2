...
@InputType()
class GoalTemplateCreateNestedManyWithoutTenantsInput {
...
export { GoalTemplateCreateNestedManyWithoutTenantsInput as GoalTemplateCreateNestedManyWithoutTenantsInput };
