...
@InputType()
class IntegrationTenantCreateNestedManyWithoutTenantsInput {
...
export { IntegrationTenantCreateNestedManyWithoutTenantsInput as IntegrationTenantCreateNestedManyWithoutTenantsInput };
