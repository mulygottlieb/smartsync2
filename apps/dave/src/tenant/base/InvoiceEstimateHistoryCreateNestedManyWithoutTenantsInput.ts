...
@InputType()
class InvoiceEstimateHistoryCreateNestedManyWithoutTenantsInput {
...
export { InvoiceEstimateHistoryCreateNestedManyWithoutTenantsInput as InvoiceEstimateHistoryCreateNestedManyWithoutTenantsInput };
