...
@InputType()
class InvoiceEstimateHistoryUpdateManyWithoutTenantsInput {
...
export { InvoiceEstimateHistoryUpdateManyWithoutTenantsInput as InvoiceEstimateHistoryUpdateManyWithoutTenantsInput };
