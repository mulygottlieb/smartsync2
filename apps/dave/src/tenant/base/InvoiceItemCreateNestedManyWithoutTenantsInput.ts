...
@InputType()
class InvoiceItemCreateNestedManyWithoutTenantsInput {
...
export { InvoiceItemCreateNestedManyWithoutTenantsInput as InvoiceItemCreateNestedManyWithoutTenantsInput };
