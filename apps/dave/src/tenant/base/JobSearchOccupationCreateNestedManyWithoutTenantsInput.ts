...
@InputType()
class JobSearchOccupationCreateNestedManyWithoutTenantsInput {
...
export { JobSearchOccupationCreateNestedManyWithoutTenantsInput as JobSearchOccupationCreateNestedManyWithoutTenantsInput };
