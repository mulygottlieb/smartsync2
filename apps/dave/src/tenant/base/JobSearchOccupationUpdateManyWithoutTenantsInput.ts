...
@InputType()
class JobSearchOccupationUpdateManyWithoutTenantsInput {
...
export { JobSearchOccupationUpdateManyWithoutTenantsInput as JobSearchOccupationUpdateManyWithoutTenantsInput };
