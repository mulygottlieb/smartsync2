...
@InputType()
class KeyResultUpdateCreateNestedManyWithoutTenantsInput {
...
export { KeyResultUpdateCreateNestedManyWithoutTenantsInput as KeyResultUpdateCreateNestedManyWithoutTenantsInput };
