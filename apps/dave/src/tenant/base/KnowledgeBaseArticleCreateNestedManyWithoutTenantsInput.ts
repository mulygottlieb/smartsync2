...
@InputType()
class KnowledgeBaseArticleCreateNestedManyWithoutTenantsInput {
...
export { KnowledgeBaseArticleCreateNestedManyWithoutTenantsInput as KnowledgeBaseArticleCreateNestedManyWithoutTenantsInput };
