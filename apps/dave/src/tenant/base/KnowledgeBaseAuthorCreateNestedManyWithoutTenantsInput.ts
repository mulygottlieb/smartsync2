...
@InputType()
class KnowledgeBaseAuthorCreateNestedManyWithoutTenantsInput {
...
export { KnowledgeBaseAuthorCreateNestedManyWithoutTenantsInput as KnowledgeBaseAuthorCreateNestedManyWithoutTenantsInput };
