...
@InputType()
class KnowledgeBaseAuthorUpdateManyWithoutTenantsInput {
...
export { KnowledgeBaseAuthorUpdateManyWithoutTenantsInput as KnowledgeBaseAuthorUpdateManyWithoutTenantsInput };
