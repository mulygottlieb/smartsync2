...
@InputType()
class OrganizationAwardCreateNestedManyWithoutTenantsInput {
...
export { OrganizationAwardCreateNestedManyWithoutTenantsInput as OrganizationAwardCreateNestedManyWithoutTenantsInput };
