...
@InputType()
class OrganizationAwardUpdateManyWithoutTenantsInput {
...
export { OrganizationAwardUpdateManyWithoutTenantsInput as OrganizationAwardUpdateManyWithoutTenantsInput };
