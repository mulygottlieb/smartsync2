...
@InputType()
class OrganizationContactCreateNestedManyWithoutTenantsInput {
...
export { OrganizationContactCreateNestedManyWithoutTenantsInput as OrganizationContactCreateNestedManyWithoutTenantsInput };
