...
@InputType()
class OrganizationDepartmentCreateNestedManyWithoutTenantsInput {
...
export { OrganizationDepartmentCreateNestedManyWithoutTenantsInput as OrganizationDepartmentCreateNestedManyWithoutTenantsInput };
