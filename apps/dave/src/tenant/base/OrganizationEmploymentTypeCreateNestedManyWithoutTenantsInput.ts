...
@InputType()
class OrganizationEmploymentTypeCreateNestedManyWithoutTenantsInput {
...
export { OrganizationEmploymentTypeCreateNestedManyWithoutTenantsInput as OrganizationEmploymentTypeCreateNestedManyWithoutTenantsInput };
