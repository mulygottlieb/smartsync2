...
@InputType()
class OrganizationEmploymentTypeUpdateManyWithoutTenantsInput {
...
export { OrganizationEmploymentTypeUpdateManyWithoutTenantsInput as OrganizationEmploymentTypeUpdateManyWithoutTenantsInput };
