...
@InputType()
class OrganizationProjectCreateNestedManyWithoutTenantsInput {
...
export { OrganizationProjectCreateNestedManyWithoutTenantsInput as OrganizationProjectCreateNestedManyWithoutTenantsInput };
