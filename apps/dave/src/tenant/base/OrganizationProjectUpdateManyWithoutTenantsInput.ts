...
@InputType()
class OrganizationProjectUpdateManyWithoutTenantsInput {
...
export { OrganizationProjectUpdateManyWithoutTenantsInput as OrganizationProjectUpdateManyWithoutTenantsInput };
