...
@InputType()
class OrganizationRecurringExpenseCreateNestedManyWithoutTenantsInput {
...
export { OrganizationRecurringExpenseCreateNestedManyWithoutTenantsInput as OrganizationRecurringExpenseCreateNestedManyWithoutTenantsInput };
