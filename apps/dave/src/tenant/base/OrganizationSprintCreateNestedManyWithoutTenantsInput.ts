...
@InputType()
class OrganizationSprintCreateNestedManyWithoutTenantsInput {
...
export { OrganizationSprintCreateNestedManyWithoutTenantsInput as OrganizationSprintCreateNestedManyWithoutTenantsInput };
