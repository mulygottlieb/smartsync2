...
@InputType()
class OrganizationTaskSettingCreateNestedManyWithoutTenantsInput {
...
export { OrganizationTaskSettingCreateNestedManyWithoutTenantsInput as OrganizationTaskSettingCreateNestedManyWithoutTenantsInput };
