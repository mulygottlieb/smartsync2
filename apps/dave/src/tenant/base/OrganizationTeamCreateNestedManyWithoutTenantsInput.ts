...
@InputType()
class OrganizationTeamCreateNestedManyWithoutTenantsInput {
...
export { OrganizationTeamCreateNestedManyWithoutTenantsInput as OrganizationTeamCreateNestedManyWithoutTenantsInput };
