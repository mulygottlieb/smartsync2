...
@InputType()
class OrganizationTeamUpdateManyWithoutTenantsInput {
...
export { OrganizationTeamUpdateManyWithoutTenantsInput as OrganizationTeamUpdateManyWithoutTenantsInput };
