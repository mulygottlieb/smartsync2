...
@InputType()
class OrganizationVendorCreateNestedManyWithoutTenantsInput {
...
export { OrganizationVendorCreateNestedManyWithoutTenantsInput as OrganizationVendorCreateNestedManyWithoutTenantsInput };
