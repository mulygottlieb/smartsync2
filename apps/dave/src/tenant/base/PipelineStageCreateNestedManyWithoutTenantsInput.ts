...
@InputType()
class PipelineStageCreateNestedManyWithoutTenantsInput {
...
export { PipelineStageCreateNestedManyWithoutTenantsInput as PipelineStageCreateNestedManyWithoutTenantsInput };
