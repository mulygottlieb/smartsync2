...
@InputType()
class ProductCategoryCreateNestedManyWithoutTenantsInput {
...
export { ProductCategoryCreateNestedManyWithoutTenantsInput as ProductCategoryCreateNestedManyWithoutTenantsInput };
