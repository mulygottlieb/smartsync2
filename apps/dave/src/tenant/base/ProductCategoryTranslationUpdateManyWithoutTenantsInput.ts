...
@InputType()
class ProductCategoryTranslationUpdateManyWithoutTenantsInput {
...
export { ProductCategoryTranslationUpdateManyWithoutTenantsInput as ProductCategoryTranslationUpdateManyWithoutTenantsInput };
