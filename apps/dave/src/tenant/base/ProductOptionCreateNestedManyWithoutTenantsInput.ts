...
@InputType()
class ProductOptionCreateNestedManyWithoutTenantsInput {
...
export { ProductOptionCreateNestedManyWithoutTenantsInput as ProductOptionCreateNestedManyWithoutTenantsInput };
