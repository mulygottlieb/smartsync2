...
@InputType()
class ProductOptionGroupCreateNestedManyWithoutTenantsInput {
...
export { ProductOptionGroupCreateNestedManyWithoutTenantsInput as ProductOptionGroupCreateNestedManyWithoutTenantsInput };
