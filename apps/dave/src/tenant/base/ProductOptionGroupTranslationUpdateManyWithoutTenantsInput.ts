...
@InputType()
class ProductOptionGroupTranslationUpdateManyWithoutTenantsInput {
...
export { ProductOptionGroupTranslationUpdateManyWithoutTenantsInput as ProductOptionGroupTranslationUpdateManyWithoutTenantsInput };
