...
@InputType()
class ProductTranslationCreateNestedManyWithoutTenantsInput {
...
export { ProductTranslationCreateNestedManyWithoutTenantsInput as ProductTranslationCreateNestedManyWithoutTenantsInput };
