...
@InputType()
class ProductTypeCreateNestedManyWithoutTenantsInput {
...
export { ProductTypeCreateNestedManyWithoutTenantsInput as ProductTypeCreateNestedManyWithoutTenantsInput };
