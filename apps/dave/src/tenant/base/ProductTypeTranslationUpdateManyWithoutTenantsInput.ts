...
@InputType()
class ProductTypeTranslationUpdateManyWithoutTenantsInput {
...
export { ProductTypeTranslationUpdateManyWithoutTenantsInput as ProductTypeTranslationUpdateManyWithoutTenantsInput };
