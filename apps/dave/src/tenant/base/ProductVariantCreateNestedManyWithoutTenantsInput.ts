...
@InputType()
class ProductVariantCreateNestedManyWithoutTenantsInput {
...
export { ProductVariantCreateNestedManyWithoutTenantsInput as ProductVariantCreateNestedManyWithoutTenantsInput };
