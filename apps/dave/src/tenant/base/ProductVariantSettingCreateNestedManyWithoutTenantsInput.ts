...
@InputType()
class ProductVariantSettingCreateNestedManyWithoutTenantsInput {
...
export { ProductVariantSettingCreateNestedManyWithoutTenantsInput as ProductVariantSettingCreateNestedManyWithoutTenantsInput };
