...
@InputType()
class ReportOrganizationCreateNestedManyWithoutTenantsInput {
...
export { ReportOrganizationCreateNestedManyWithoutTenantsInput as ReportOrganizationCreateNestedManyWithoutTenantsInput };
