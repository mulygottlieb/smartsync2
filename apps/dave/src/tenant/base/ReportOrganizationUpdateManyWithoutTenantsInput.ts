...
@InputType()
class ReportOrganizationUpdateManyWithoutTenantsInput {
...
export { ReportOrganizationUpdateManyWithoutTenantsInput as ReportOrganizationUpdateManyWithoutTenantsInput };
