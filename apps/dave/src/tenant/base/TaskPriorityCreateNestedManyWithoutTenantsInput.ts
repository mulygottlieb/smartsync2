...
@InputType()
class TaskPriorityCreateNestedManyWithoutTenantsInput {
...
export { TaskPriorityCreateNestedManyWithoutTenantsInput as TaskPriorityCreateNestedManyWithoutTenantsInput };
