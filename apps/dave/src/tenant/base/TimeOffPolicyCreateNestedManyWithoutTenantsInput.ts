...
@InputType()
class TimeOffPolicyCreateNestedManyWithoutTenantsInput {
...
export { TimeOffPolicyCreateNestedManyWithoutTenantsInput as TimeOffPolicyCreateNestedManyWithoutTenantsInput };
