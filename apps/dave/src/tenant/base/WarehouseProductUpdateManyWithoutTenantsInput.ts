...
@InputType()
class WarehouseProductUpdateManyWithoutTenantsInput {
...
export { WarehouseProductUpdateManyWithoutTenantsInput as WarehouseProductUpdateManyWithoutTenantsInput };
