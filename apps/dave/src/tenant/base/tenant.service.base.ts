...
export class TenantServiceBase {
  ...
  async count<T extends Prisma.TenantCountArgs>(
  ...
  async findImageAssetImageAssetTenantIdTotenant(
    parentId: string,
    ...
    return this.prisma.tenant
      ...
      .imageAssetImageAssetTenantIdTotenant(args);
  }

  async findImportHistory(
    parentId: string,
    args: Prisma.ImportHistoryFindManyArgs
  ...
  async findImportRecord(
    parentId: string,
    args: Prisma.ImportRecordFindManyArgs
  ...
  async findTenantSetting(
    parentId: string,
    args: Prisma.TenantSettingFindManyArgs
  ...
  async getImageAssetTenantImageIdToimageAsset(
    parentId: string
