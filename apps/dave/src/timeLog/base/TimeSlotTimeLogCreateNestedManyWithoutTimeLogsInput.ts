...
@InputType()
class TimeSlotTimeLogCreateNestedManyWithoutTimeLogsInput {
...
export { TimeSlotTimeLogCreateNestedManyWithoutTimeLogsInput as TimeSlotTimeLogCreateNestedManyWithoutTimeLogsInput };
