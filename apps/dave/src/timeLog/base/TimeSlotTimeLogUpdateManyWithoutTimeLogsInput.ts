...
@InputType()
class TimeSlotTimeLogUpdateManyWithoutTimeLogsInput {
...
export { TimeSlotTimeLogUpdateManyWithoutTimeLogsInput as TimeSlotTimeLogUpdateManyWithoutTimeLogsInput };
