...
@InputType()
class ActivityCreateNestedManyWithoutTimeSlotsInput {
...
export { ActivityCreateNestedManyWithoutTimeSlotsInput as ActivityCreateNestedManyWithoutTimeSlotsInput };
