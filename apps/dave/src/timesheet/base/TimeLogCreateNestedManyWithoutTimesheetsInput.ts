...
@InputType()
class TimeLogCreateNestedManyWithoutTimesheetsInput {
...
export { TimeLogCreateNestedManyWithoutTimesheetsInput as TimeLogCreateNestedManyWithoutTimesheetsInput };
