...
@InputType()
class InvoiceEstimateHistoryCreateNestedManyWithoutUsersInput {
...
export { InvoiceEstimateHistoryCreateNestedManyWithoutUsersInput as InvoiceEstimateHistoryCreateNestedManyWithoutUsersInput };
