...
@InputType()
class InvoiceEstimateHistoryUpdateManyWithoutUsersInput {
...
export { InvoiceEstimateHistoryUpdateManyWithoutUsersInput as InvoiceEstimateHistoryUpdateManyWithoutUsersInput };
