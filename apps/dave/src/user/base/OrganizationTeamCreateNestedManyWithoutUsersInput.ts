...
@InputType()
class OrganizationTeamCreateNestedManyWithoutUsersInput {
...
export { OrganizationTeamCreateNestedManyWithoutUsersInput as OrganizationTeamCreateNestedManyWithoutUsersInput };
