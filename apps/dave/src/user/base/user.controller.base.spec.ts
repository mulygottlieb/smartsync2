...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  thirdPartyId: "exampleThirdPartyId",
  ...
  isActive: "true",
  code: 42,
  codeExpireAt: new Date(),
  emailVerifiedAt: new Date(),
  emailToken: "exampleEmailToken",
  ...
  test("POST /users", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        codeExpireAt: CREATE_RESULT.codeExpireAt.toISOString(),
      ...
      .expect([
        {
          ...
          codeExpireAt: FIND_MANY_RESULT[0].codeExpireAt.toISOString(),
  ...
  test("GET /users/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        codeExpireAt: FIND_ONE_RESULT.codeExpireAt.toISOString(),
