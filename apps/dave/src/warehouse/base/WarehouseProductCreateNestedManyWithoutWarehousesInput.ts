...
@InputType()
class WarehouseProductCreateNestedManyWithoutWarehousesInput {
...
export { WarehouseProductCreateNestedManyWithoutWarehousesInput as WarehouseProductCreateNestedManyWithoutWarehousesInput };
