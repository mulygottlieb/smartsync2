...
@InputType()
class WarehouseProductUpdateManyWithoutWarehousesInput {
...
export { WarehouseProductUpdateManyWithoutWarehousesInput as WarehouseProductUpdateManyWithoutWarehousesInput };
